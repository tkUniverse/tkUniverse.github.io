...
//     bodyElement.classList.toggle('light-theme', !isLightTheme);
//     bodyElement.classList.toggle('dark-theme', isLightTheme);

//     themeToggleButton.textContent = isLightTheme ? 'Switch to Light Theme' : 'Switch to Dark Theme';
//   });
